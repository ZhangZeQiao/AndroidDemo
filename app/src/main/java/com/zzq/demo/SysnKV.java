 ...
 * https://blog.csdn.net/qq_27512671/article/details/101445642
 *
 * 由于之前 map - json - file 转换的时候目前是整个替换，随着数据的增大，读写速度将显著提升，因此从这一块做了优化。
 * 方法为根据数据的大小，给文件分成多块。每个分块文件都比较小，满足了映射文件读写效率的问题，同时每个分块文件单独持有一个锁，不互斥，提升性能。
 * */
